...
<div class="timeline-cover-section">
	...
	<div class="timeline-list">
		<ul class="list-inline pagelike-links">							
			...
			<li class="{{ Request::segment(2) == 'zedcoin-account' ? 'active' : '' }}"><a href="{{ url($timeline->username.'/zedcoin-account') }}" ><span class="top-list">{{ $joined_groups_count }}  {{ trans('common.zedcoin_account') }}</span></a></li>
			<li class="{{ Request::segment(2) == 'zedcoin-account' ? 'active' : '' }}"><a href="{{ url($timeline->username.'/zedcoin-pay') }}" ><span class="top-list">{{ $joined_groups_count }}  {{ trans('common.deposit') }}</span></a></li>
			<li class="{{ Request::segment(2) == 'joined-groups' ? 'active' : '' }}"><a href="{{ url($timeline->username.'/joined-groups') }}" ><span class="top-list">{{ $joined_groups_count }}  {{ trans('common.shares') }}</span></a></li>
			<li class="{{ Request::segment(2) == 'joined-groups' ? 'active' : '' }}"><a href="{{ url($timeline->username.'/joined-groups') }}" ><span class="top-list">{{ $joined_groups_count }}  {{ trans('common.socialfund') }}</span></a></li>
			<li class="{{ Request::segment(2) == 'joined-groups' ? 'active' : '' }}"><a href="{{ url($timeline->username.'/joined-groups') }}" ><span class="top-list">{{ $joined_groups_count }}  {{ trans('common.loan') }}</span></a></li>
