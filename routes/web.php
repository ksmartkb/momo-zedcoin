...
Route::group(['prefix' => '/{username}', 'middleware' => 'auth'], function ($username) {
    ...
    Route::get('/zedcoin-account', 'UserController@zedcoinAccount');
    Route::get('/zedcoin-pay', 'UserController@mtnTransactionCollection');
    ...
    Route::get('/groupshares/{group_id}', 'TimelineController@getGroupShares');
    ...
    Route::get('/groupshareview/{group_id}', 'TimelineController@viewShare');
...
Route::group(['prefix' => 'ajax', 'middleware' => ['auth']], function () {
    ...
    Route::post('create-share', 'TimelineController@createShare');
